...
export const mockArticles: NewsArticle[] = [
  {
    ...
    excerpt: 'تشهد العاصمة الخرطوم تحركات سياسية مكثفة تهدف إلى التوصل لاتفاق شامل ينهي الأزمة الراهنة.',
    content: 'تشهد الساحة السياسية السودانية حراكاً دبلوماسياً واسعاً، مع تقدم ملحوظ في المفاوضات.',
    category: 'politics',
  ...
  },
  {
    ...
    content: 'يشهد الاقتصاد السوداني بعض مؤشرات الاستقرار النسبي بعد سلسلة من الإجراءات.',
    category: 'economy',
    author: 'سارة محمد',
  ...
  },
  {
    ...
    content: 'ناقشت القمة آليات دعم السلام والاستقرار الدائم في المنطقة.',
