...
export const mockArticles: NewsArticle[] = [
  {
    ...
    excerpt:
      'تشهد العاصمة الخرطوم تحركات سياسية مكثفة تهدف إلى التوصل لاتفاق شامل ينهي الأزمة الراهنة ويمهد لمرحلة انتقالية مستقرة.',
  ...
  },
  {
    ...
    excerpt:
      'سجل الجنيه السوداني استقراراً نسبياً خلال الفترة الأخيرة.',
    content:
      'يشهد الاقتصاد السوداني بعض مؤشرات الاستقرار النسبي.',
    category: 'economy',
    author: 'سارة محمد',
